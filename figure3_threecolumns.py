...
plt.savefig('./figures_for_article/figure3.png', format="png", dpi=300, bbox_inches='tight')
plt.savefig('./figures_for_article/figure3.svg', format="svg", dpi=600, bbox_inches='tight')
